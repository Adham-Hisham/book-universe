...
#this project is still in development and there will be always room for improvments and debugging
...
#this function is called to initialize the database openinng the file making it ready to use for other functions
...
#using ofcourse the print function we print the  name line by line
def intro():
    print("==================================================================================")
    print("  ____                 _      _    _         _                              ")
    print(" |  _ \               | |    | |  | |       (_)                             ")
...
def add_stock():
    ...
    id = input("enter ID to add stock:")
    stock = int(input("enter number of books to add:"))
...
#modifying the list items and adding the new stock and calculating the  new total value
